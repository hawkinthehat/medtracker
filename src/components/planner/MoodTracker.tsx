            ...
            {MOOD_SCALE.map(({ value, label }, i) => {
              ...
              return (
                <button
                  ...
                  className="group flex min-w-[4.25rem] flex-1 flex-col items-center gap-2 rounded-2xl border border-slate-700/80 bg-slate-950/70 px-2 py-3 shadow-inner transition hover:border-sky-500/50 hover:bg-slate-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-400 disabled:opacity-50"
                >
            ...
            {BRAIN_FOG_STEPS.map(({ score, label }, i) => {
              ...
              return (
                <button
                  ...
                  className="group flex min-w-[4.25rem] flex-1 flex-col items-center gap-2 rounded-2xl border border-slate-700/80 bg-slate-950/70 px-2 py-3 shadow-inner transition hover:border-violet-500/45 hover:bg-slate-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-400 disabled:opacity-50"
                >
                  <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-b from-slate-800 to-slate-950 ring-1 ring-white/10 transition group-active:scale-95">
